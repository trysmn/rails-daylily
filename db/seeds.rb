...
events_array = [ { title: "London Cocktail Week",
  description: "Join a seven-day cocktail party celebrating the capital's top bars, mixologists and cocktail scene during London Cocktail Week (LCW). Hosted by DrinkUp.London, the same team behind London Beer Week and Wine Week, the annual festival features a vibrant cocktail village as well as special offers at more than 250 bars, restaurants and pop-ups all over the city. First off, download the London Cocktail Week app where you can buy the £10 festival pass and locate the participating bars, which serve up their signature cocktails for £6 to all LCW pass holders. The Cocktail Village also returns to Old Spitalfields Market with £6 cocktails from the biggest drink names on the market and up-and-coming brands, as well as tempting food stalls. Plus, learn how spirits are made, master your favourite cocktail mix or discover how best to pair cocktails with food, while meeting other cocktail fans, with tours, masterclasses, parties and more London Cocktail Week events.",
  ...
  { title: "Barcelona Wine and Cava Festival",
    description: "The Mostra de Vins i Caves de Catalunya is once again at the Arc de Triomf monument on Passeig de Lluis Company.  Taking part are over 70 top wineries present wines from 12 Catalan denominations of origin including DO Alella, Catalonia, Cava, Conca de Barbera, Costers del Segre, Empordà Montsant Penedès Pla de Bages, Priorat, Tarragona and Terra Alta regions. On Sunday 29th October 2017 the wine festival includes the 'Trobada d'Intercanvi de Plaques de Cava Diada 2017' event from 10am to 2pm where collectors of Cava bottle top wrappers - called a 'chapa de cava,' meet to buy and sell cava tops.",
  ...
  { title: "Barcelona Boat Show",
    description: "The 2017 Barcelona Boat Show welcomes you to the 55th edition. Barcelona boat show is a 5 day boat show with over 300 Spanish and foreign exhibitors, around 700 boats and more than 1,300 sailors taking part in the annual Catalan Sailing Week. The Barcelona boat show is a floating boat show in Barcelona's marina the Port Vell marina with more than 165 craft on the water, so that visitors have many opportunities to test-drives boats.  The Barcelona Salon Nautico is regarded as one of the top three boat shows in Europe in terms of both quality and attendance figures. Salon Nautico has the best setting in the Mediterranean, with many restaurants, a nautical atmosphere and an outstanding location close to the sea which make this a unique exhibition.",
